...
#2. What was the total discount given during the sale period? 
...
#3.  How does the sale performance compare in terms of units sold before and during the sale? 
...
#4. What was the average discount rate applied to products sold during the sale? 
...
#5. Which day had the highest revenue, and what was the top-selling product on that day? 
...
#6. How many units were sold per product category during the sale?  
...
#7. What was the total number of transactions each day? 
...
#8. Which product had the largest discount impact on revenue? 
